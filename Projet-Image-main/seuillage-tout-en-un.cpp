...
ImageGris intensite(ImageGris img) {
    ...
    throw runtime_error("Fonction intensite non implantée ligne 44");
}
...
ImageGris lirePGM(string source) {
    // Remplacez cette ligne et la suivante par le code adéquat
    throw runtime_error("Fonction lirePGM non implantée ligne 54");
}
...
void ecrirePGM(ImageGris img, string cible) {
    // Remplacez cette ligne et la suivante par le code adéquat
    throw runtime_error("Fonction ecrirePGM non implantée ligne 65");
}
...
ImageGris renormalise(ImageGris img) {
    // Remplacez cette ligne et la suivante par le code adéquat
    throw runtime_error("Fonction renormalise non implantée ligne 104");
}
...
ImageGris seuillage(ImageGris img, int seuil) {
    // Remplacez cette ligne et la suivante par le code adéquat
    throw runtime_error("Fonction seuillage non implantée ligne 130");
}
...
ImageGris doubleSeuillage(ImageGris imgIntensite, ImageGris imgContour, int seuil) {
    // Remplacez cette ligne et la suivante par le code adéquat
    throw runtime_error("Fonction doubleSeuillage non implantée ligne 145");
}
